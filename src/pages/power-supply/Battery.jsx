      ...
      <main className="max-w-5xl mx-auto p-6 space-y-12 bg-base text-base rounded-lg shadow-md">
        <section className="flex flex-col lg:flex-row items-center gap-8 bg-content-base p-6 rounded-lg">
          <div className="lg:w-1/2">
            <h1 className="text-3xl font-semibold mb-4">Battery Overview</h1>
            <p className="text-base">
              Batteries are energy storage devices that supply power to
              electronic circuits and devices. They come in various chemistries
              and sizes, providing DC voltage and current.
            </p>
          </div>
          <div className="lg:w-1/2">
            <img
