      ...
      <main className="max-w-5xl mx-auto p-6 space-y-12 bg-base text-base rounded-lg shadow-md">
        <section className="flex flex-col lg:flex-row items-center gap-8 bg-content-base p-6 rounded-lg">
          <div className="lg:w-1/2">
            <h1 className="text-3xl font-semibold mb-4">RTC Module Overview</h1>
            <p className="text-base">
              An RTC (Real-Time Clock) module is used to keep track of the
              current time and date, even when the main microcontroller is
              turned off. It is often used in time-sensitive applications.
            </p>
          </div>
          <div className="lg:w-1/2">
            <img
        ...
        <section className="bg-content-base p-6 rounded-lg">
          <h2 className="text-2xl font-semibold mb-4">
            RTC Module Datasheet (PDF Viewer)
          </h2>
