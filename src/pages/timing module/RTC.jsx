      ...
      <section className="flex flex-col lg:flex-row items-center gap-8 bg-content-base p-6 rounded-lg">
        <div className="lg:w-1/2">
          ...
          <p className="text-base">
            An RTC (Real-Time Clock) module is used to keep track of the current
            time and date, even when the main microcontroller is turned off. It
            is often used in time-sensitive applications.
          </p>
        </div>
        <div className="lg:w-1/2">
          <img
