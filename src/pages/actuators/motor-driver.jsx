    ...
    <main className="max-w-5xl mx-auto p-6 space-y-12 bg-base text-base rounded-lg shadow-md">
      <section className="flex flex-col lg:flex-row items-center gap-8 bg-content-base p-6 rounded-lg">
        <div className="lg:w-1/2">
          <h1 className="text-3xl font-semibold mb-4">Motor Driver Overview</h1>
          <p className="text-base">
            Motor drivers like the L298N and L293D allow microcontrollers to
            control the direction and speed of DC motors and stepper motors.
            They act as intermediaries, providing the necessary current and
            voltage to drive motors safely.
          </p>
        </div>
        <div className="lg:w-1/2">
          <img
      ...
      <section className="bg-content-base p-6 rounded-lg">
        <h2 className="text-2xl font-semibold mb-4">
          Motor Driver Datasheet (PDF Viewer)
        </h2>
