    ...
    <main className="max-w-5xl mx-auto p-6 space-y-12 bg-base text-base rounded-lg shadow-md">
      <section className="flex flex-col lg:flex-row items-center gap-8 bg-content-base p-6 rounded-lg">
        <div className="lg:w-1/2">
          <h1 className="text-3xl font-semibold mb-4">Servo Motor Overview</h1>
          <p className="text-base">
            A servo motor is a rotary actuator that allows for precise control
            of angular position. Commonly used in robotics, RC vehicles, and
            automation, it includes a motor, feedback sensor, and control
            circuitry in a compact unit.
          </p>
        </div>
        <div className="lg:w-1/2">
          <img
