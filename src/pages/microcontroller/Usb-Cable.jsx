      ...
      <main className="max-w-5xl mx-auto p-6 space-y-12 bg-base text-base rounded-lg shadow-md">
        <section className="flex flex-col lg:flex-row items-center gap-8 bg-content-base p-6 rounded-lg">
          <div className="lg:w-1/2">
            <h1 className="text-3xl font-semibold mb-4">USB Cable Overview</h1>
            <p className="text-base">
              A USB (Universal Serial Bus) cable is commonly used for data
              transfer and power supply between computers, microcontrollers, and
              peripherals. It supports plug-and-play functionality and is a
              standard interface in embedded systems, consumer electronics, and
              computing.
            </p>
          </div>
          <div className="lg:w-1/2">
            <img
              src="/src/assets/images/6430751f969a9a5bb4239071-1pcs-mini-usb-cable-for-arduino-nano.jpg"
              alt="USB Cable"
        ...
        <section className="bg-content-base p-6 rounded-lg">
          <h2 className="text-2xl font-semibold mb-4">
            USB Cable Datasheet (PDF Viewer)
          </h2>
