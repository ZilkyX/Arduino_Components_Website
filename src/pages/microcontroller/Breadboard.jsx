...
const Breadboard = () => {
  ...
  const videoUrl = "/src/assets/3D Video/Bread Board.mp4";
      ...
      <main className="max-w-5xl mx-auto p-6 space-y-12 bg-base text-base rounded-lg shadow-md">
        <section className="flex flex-col lg:flex-row items-center gap-8 bg-content-base p-6 rounded-lg">
          <div className="lg:w-1/2">
            <h1 className="text-3xl font-semibold mb-4">Breadboard Overview</h1>
            <p className="text-base">
              A breadboard is a construction base used for prototyping
              electronics. It allows components to be quickly connected and
              rearranged without soldering, making it ideal for testing
              circuits.
            </p>
          </div>
          <div className="lg:w-1/2">
