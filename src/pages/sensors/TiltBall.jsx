      ...
      <section className="flex flex-col lg:flex-row items-center gap-8 bg-content-base p-6 rounded-lg">
        <div className="lg:w-1/2">
          ...
          <p className="text-base">
            The tilt ball switch is a simple sensor that detects orientation or
            tilt. It contains a small metal ball that moves and makes or breaks
            contact depending on the sensor's position, often used in alarms,
            orientation detection, and motion-based triggers.
          </p>
        </div>
        <div className="lg:w-1/2">
          <img
