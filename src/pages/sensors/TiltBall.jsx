  ...
  return (
    <div className="min-h-screen overflow-auto touch-auto bg-base">
      <main className="max-w-5xl mx-auto p-6 space-y-12 bg-base text-base rounded-lg shadow-md">
        <section className="flex flex-col lg:flex-row items-center gap-8 bg-content-base p-6 rounded-lg">
          <div className="lg:w-1/2">
            <h1 className="text-3xl font-semibold mb-4">
              Tilt Ball Switch Overview
            </h1>
            <p className="text-base">
              The tilt ball switch is a simple sensor that detects orientation
              or tilt. It contains a small metal ball that moves and makes or
              breaks contact depending on the sensor's position, often used in
              alarms, orientation detection, and motion-based triggers.
            </p>
          </div>
          <div className="lg:w-1/2">
            <img
        ...
        <section className="bg-content-base p-6 rounded-lg">
          <h2 className="text-2xl font-semibold mb-4">
            Tilt Ball Switch Datasheet (PDF Viewer)
          </h2>
