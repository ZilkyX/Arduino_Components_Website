    ...
    <main className="max-w-5xl mx-auto p-6 space-y-12 bg-base text-base rounded-lg shadow-md">
      <section className="flex flex-col lg:flex-row items-center gap-8 bg-content-base p-6 rounded-lg">
        <div className="lg:w-1/2">
          <h1 className="text-3xl font-semibold mb-4">Flame Sensor Overview</h1>
          <p className="text-base">
            A flame sensor is used to detect fire or flames based on the
            infrared (IR) light emitted. These sensors are typically used in
            safety systems to detect fire outbreaks, or in robotics and home
            automation for flame monitoring. They are sensitive to IR light in
            the 760nm–1100nm range.
          </p>
        </div>
        <div className="lg:w-1/2">
          <img
      ...
      <section className="bg-content-base p-6 rounded-lg">
        <h2 className="text-2xl font-semibold mb-4">
          Flame Sensor Datasheet (PDF Viewer)
        </h2>
