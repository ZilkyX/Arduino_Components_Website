  ...
  return (
    <div className="min-h-screen overflow-auto touch-auto bg-base">
      <main className="max-w-5xl mx-auto p-6 space-y-12 bg-base text-base rounded-lg shadow-md">
        <section className="flex flex-col lg:flex-row items-center gap-8 bg-content-base p-6 rounded-lg">
          <div className="lg:w-1/2">
            <h1 className="text-3xl font-semibold mb-4">
              Photoresistor (LDR) Overview
            </h1>
            <p className="text-base">
              A photoresistor, also known as an LDR (Light Dependent Resistor),
              is a light-sensitive component used to detect ambient light
              levels. It's commonly used in light-activated switches, automatic
              lighting, and solar garden lights.
            </p>
          </div>
          <div className="lg:w-1/2">
            <img
        ...
        <section className="bg-content-base p-6 rounded-lg">
          <h2 className="text-2xl font-semibold mb-4">
            Photoresistor Datasheet (PDF Viewer)
          </h2>
