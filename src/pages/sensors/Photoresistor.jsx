      ...
      <section className="flex flex-col lg:flex-row items-center gap-8 bg-content-base p-6 rounded-lg">
        <div className="lg:w-1/2">
          ...
          <p className="text-base">
            A photoresistor, also known as an LDR (Light Dependent Resistor), is
            a light-sensitive component used to detect ambient light levels.
            It's commonly used in light-activated switches, automatic lighting,
