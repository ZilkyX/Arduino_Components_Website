        ...
        <section className="flex flex-col lg:flex-row items-center gap-8 bg-content-base p-6 rounded-lg">
          <div className="lg:w-1/2">
            ...
            <p className="text-base">
              A sound sensor detects sound levels in the environment and
              converts them into electrical signals. It is commonly used in
              projects that require audio detection, such as noise level
              monitoring, voice activation, and sound-activated switches.
            </p>
          </div>
          <div className="lg:w-1/2">
            <img
