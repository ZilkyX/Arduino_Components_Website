    ...
    <main className="max-w-5xl mx-auto p-6 space-y-12 bg-base text-base rounded-lg shadow-md">
      <section className="flex flex-col lg:flex-row items-center gap-8 bg-content-base p-6 rounded-lg">
        <div className="lg:w-1/2">
          <h1 className="text-3xl font-semibold mb-4">Sound Sensor Overview</h1>
          <p className="text-base">
            A sound sensor detects sound levels in the environment and converts
            them into electrical signals. It is commonly used in projects that
            require audio detection, such as noise level monitoring, voice
            activation, and sound-activated switches.
          </p>
        </div>
        <div className="lg:w-1/2">
          <img
      ...
      <section className="bg-content-base p-6 rounded-lg">
        <h2 className="text-2xl font-semibold mb-4">
          Sound Sensor Datasheet (PDF Viewer)
        </h2>
