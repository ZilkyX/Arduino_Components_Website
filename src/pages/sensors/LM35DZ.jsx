      ...
      <main className="max-w-5xl mx-auto p-6 space-y-12 bg-base text-base rounded-lg shadow-md">
        <section className="flex flex-col lg:flex-row items-center gap-8 bg-content-base p-6 rounded-lg">
          <div className="lg:w-1/2">
            <h1 className="text-3xl font-semibold mb-4">LM35DZ Overview</h1>
            <p className="text-base">
              The LM35DZ is a precision integrated-circuit temperature sensor,
              whose output voltage is linearly proportional to the Celsius
              temperature. It is widely used in temperature-sensing applications
              due to its accuracy and simplicity.
            </p>
          </div>
          <div className="lg:w-1/2">
            <img
              src="/src/assets/images/lm35-temperature-sensor-500x500.webp"
              alt="LM35DZ Temperature Sensor"
        ...
        <section className="bg-content-base p-6 rounded-lg">
          ...
          <div className="aspect-w-16 aspect-h-9">
            <video
              ...
              src="/src/assets/3D Video/LM35DZ.mp4"
              type="video/mp4"
            >
