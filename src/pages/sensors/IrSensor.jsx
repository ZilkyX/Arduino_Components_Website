        ...
        <section className="flex flex-col lg:flex-row items-center gap-8 bg-content-base p-6 rounded-lg">
          <div className="lg:w-1/2">
            ...
            <p className="text-base">
              An Infrared (IR) sensor detects infrared radiation from
              surrounding objects. It is commonly used for obstacle detection,
              proximity sensing, and line-following robots. IR sensors work by
              emitting and receiving infrared light and can detect changes in
              light reflection from nearby objects.
            </p>
          </div>
          <div className="lg:w-1/2">
            <img
