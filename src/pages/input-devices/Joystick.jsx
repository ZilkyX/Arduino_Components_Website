      ...
      <main className="max-w-5xl mx-auto p-6 space-y-12 bg-base text-base rounded-lg shadow-md">
        <section className="flex flex-col lg:flex-row items-center gap-8 bg-content-base p-6 rounded-lg">
          <div className="lg:w-1/2">
            <h1 className="text-3xl font-semibold mb-4">Joystick Overview</h1>
            <p className="text-base">
              A joystick is an input device consisting of a stick that pivots on
              a base and reports its angle or direction to the device it
              controls. Joysticks are commonly used to control video games and
              industrial machinery.
            </p>
          </div>
          <div className="lg:w-1/2">
            <img
              src="/src/assets/images/modulo_joystick_compatible_con_arduino.webp"
              alt="Joystick"
