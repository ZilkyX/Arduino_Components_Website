        ...
        <section className="flex flex-col lg:flex-row items-center gap-8 bg-content-base p-6 rounded-lg">
          <div className="lg:w-1/2">
            ...
            <p className="text-base">
              The RC522 is a popular RFID reader/writer module used for 13.56MHz
              contactless communication. It’s commonly used in security systems,
              attendance tracking, and access control. The module communicates
              via SPI or I2C and supports reading RFID tags and cards with ease.
            </p>
          </div>
          <div className="lg:w-1/2">
            <img
              src="/src/assets/images/be97de9b-60df-48e9-9f51-af07a16f7aee.jpg"
              alt="RC522 RFID Module"
