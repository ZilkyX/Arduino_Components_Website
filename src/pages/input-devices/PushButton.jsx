  ...
  return (
    <div className="min-h-screen overflow-auto touch-auto bg-base">
      <main className="max-w-5xl mx-auto p-6 space-y-12 bg-base text-base rounded-lg shadow-md">
        <section className="flex flex-col lg:flex-row items-center gap-8 bg-content-base p-6 rounded-lg">
          <div className="lg:w-1/2">
            ...
            <p className="text-base">
              A push button is a simple mechanical switch that allows users to
              create a temporary electrical connection. When pressed, it
              completes a circuit, and when released, the circuit is broken.
              Commonly used in microcontroller projects for user input,
              triggering events, and toggling states.
            </p>
          </div>
          <div className="lg:w-1/2">
            <img
        ...
        <section className="bg-content-base p-6 rounded-lg">
          <h2 className="text-2xl font-semibold mb-4">
            Push Button Datasheet (PDF Viewer)
          </h2>
