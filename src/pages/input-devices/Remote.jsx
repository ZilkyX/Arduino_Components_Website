      ...
      <section className="flex flex-col lg:flex-row items-center gap-8 bg-content-base p-6 rounded-lg">
        <div className="lg:w-1/2">
          ...
          <p className="text-base">
            Remote controls use infrared (IR) signals or radio frequency (RF) to
            wirelessly operate devices such as TVs, audio systems, and other
            electronics. They transmit coded signals to receivers that interpret
            commands for controlling the device functions.
          </p>
        </div>
        <div className="lg:w-1/2">
          <img
