...
const RemoteControl = () => {
  ...
  const pdfUrl = "/src/assets/PDF/REMOTE.pdf";
  ...
  return (
    <div className="min-h-screen overflow-auto touch-auto bg-base">
      <main className="max-w-5xl mx-auto p-6 space-y-12 bg-base text-base rounded-lg shadow-md">
        <section className="flex flex-col lg:flex-row items-center gap-8 bg-content-base p-6 rounded-lg">
          <div className="lg:w-1/2">
            ...
            <p className="text-base">
              Remote controls use infrared (IR) signals or radio frequency (RF)
              to wirelessly operate devices such as TVs, audio systems, and
              other electronics. They transmit coded signals to receivers that
              interpret commands for controlling the device functions.
            </p>
          </div>
          <div className="lg:w-1/2">
            <img
        ...
        <section className="bg-content-base p-6 rounded-lg">
          <h2 className="text-2xl font-semibold mb-4">
            Remote Control Datasheet (PDF Viewer)
          </h2>
