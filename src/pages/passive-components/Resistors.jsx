      ...
      <main className="max-w-5xl mx-auto p-6 space-y-12 bg-base text-base rounded-lg shadow-md">
        <section className="flex flex-col lg:flex-row items-center gap-8 bg-content-base p-6 rounded-lg">
          <div className="lg:w-1/2">
            <h1 className="text-3xl font-semibold mb-4">Resistor Overview</h1>
            <p className="text-base">
              A resistor is a passive two-terminal electrical component that
              implements electrical resistance as a circuit element. It reduces
              current flow, adjusts signal levels, divides voltages, and
              terminates transmission lines. Resistors are essential components
