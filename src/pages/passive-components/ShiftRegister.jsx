...
const ShiftRegister74HC595 = () => {
  const modelUrl = "/src/assets/models/35. 74HC595.gltf";
  const pdfUrl = "/src/assets/PDF/74HC595.pdf";
  ...
  return (
    <div className="min-h-screen overflow-auto touch-auto bg-base">
      <main className="max-w-5xl mx-auto p-6 space-y-12 bg-base text-base rounded-lg shadow-md">
        <section className="flex flex-col lg:flex-row items-center gap-8 bg-content-base p-6 rounded-lg">
          <div className="lg:w-1/2">
            <h1 className="text-3xl font-semibold mb-4">74HC595 Overview</h1>
            <p className="text-base">
              The 74HC595 is an 8-bit serial-in, parallel-out shift register. It
              allows you to control multiple outputs using just a few
              microcontroller pins, making it useful for driving LEDs, displays,
              and other digital components. It includes a storage register and a
              shift register with separate clocks for data movement and
              latching.
            </p>
          </div>
          <div className="lg:w-1/2">
...
export default ShiftRegister74HC595;
