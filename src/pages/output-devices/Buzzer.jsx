      ...
      <main className="max-w-5xl mx-auto p-6 space-y-12 bg-base text-base rounded-lg shadow-md">
        <section className="flex flex-col lg:flex-row items-center gap-8 bg-content-base p-6 rounded-lg">
          <div className="lg:w-1/2">
            <h1 className="text-3xl font-semibold mb-4">Buzzer Overview</h1>
            <p className="text-base">
              A buzzer is an audio signaling device that produces a buzzing or
              beeping sound. It is often used in electronics for alarms, timers,
              and user interface feedback. Buzzers can be passive (requiring a
              signal) or active (with built-in oscillation).
            </p>
          </div>
          <div className="lg:w-1/2">
            <img
