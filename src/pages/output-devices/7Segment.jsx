        ...
        <section className="flex flex-col lg:flex-row items-center gap-8 bg-content-base p-6 rounded-lg">
          <div className="lg:w-1/2">
            <h1 className="text-3xl font-semibold mb-4">
              1-Digit 7-Segment Tube Overview
            </h1>
            <p className="text-base">
              A 1-digit 7-segment display is used to visually represent decimal
              numbers by illuminating combinations of seven segments. It is
              commonly used in clocks, counters, and electronic meters for
              numeric output.
            </p>
          </div>
          <div className="lg:w-1/2">
