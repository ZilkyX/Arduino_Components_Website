      ...
      <main className="max-w-5xl mx-auto p-6 space-y-12 bg-base text-base rounded-lg shadow-md">
        <section className="flex flex-col lg:flex-row items-center gap-8 bg-content-base p-6 rounded-lg">
          <div className="lg:w-1/2">
            <h1 className="text-3xl font-semibold mb-4">LCD 16x2 Overview</h1>
            <p className="text-base">
              The LCD 16x2 is a widely used alphanumeric display module that can
              show 16 characters per line on 2 lines. It's often used in
              embedded and microcontroller-based systems for displaying simple
              output, messages, and sensor readings.
            </p>
          </div>
          <div className="lg:w-1/2">
            <img
              src="/src/assets/images/242754-Edit.jpg"
              alt="LCD 16x2 Module"
