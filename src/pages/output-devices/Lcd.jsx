      ...
      <section className="flex flex-col lg:flex-row items-center gap-8 bg-content-base p-6 rounded-lg">
        <div className="lg:w-1/2">
          ...
          <p className="text-base">
            ...
            show 16 characters per line on 2 lines. It's often used in embedded
            and microcontroller-based systems for displaying simple output,
            messages, and sensor readings.
          </p>
        </div>
        <div className="lg:w-1/2">
          <img
