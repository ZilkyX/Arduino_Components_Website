        ...
        <section className="flex flex-col lg:flex-row items-center gap-8 bg-content-base p-6 rounded-lg">
          <div className="lg:w-1/2">
            <h1 className="text-3xl font-semibold mb-4">
              LED Matrix Module Overview
            </h1>
            <p className="text-base">
              An LED matrix is a grid of LEDs arranged in rows and columns used
              to display characters, symbols, or graphics. Modules like the 8x8
              MAX7219 LED matrix allow easy control using SPI communication with
              microcontrollers.
            </p>
          </div>
          <div className="lg:w-1/2">
