        ...
        <section className="flex flex-col lg:flex-row items-center gap-8 bg-content-base p-6 rounded-lg">
          <div className="lg:w-1/2">
            ...
            <p className="text-base">
              Relay modules allow microcontrollers to control high voltage or
              high current devices safely by acting as electrically operated
              switches. They isolate the low-voltage control circuit from the
              high-power load.
            </p>
          </div>
          <div className="lg:w-1/2">
